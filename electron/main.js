...
sqlite.run('CREATE TABLE IF NOT EXISTS caseXmodule (case_module_ID INTEGER PRIMARY KEY AUTOINCREMENT, case_ID	INTEGER, module_ID 	INTEGER, requestActive BOOLEAN, begruendung TEXT, anerkannt INTEGER DEFAULT 0, extModuleName 	TEXT, FOREIGN KEY( module_ID ) REFERENCES module ( moduleID ),FOREIGN KEY( case_ID ) REFERENCES cases ( caseID ))');
